...
export default function SignupPage() {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-[rgb(241, 242, 238)] from-primary-50 via-white to-surface-secondary p-4">
      <div className="w-full max-w-md">
        <div className="mb-8 text-center">
          <img height="50" width="50" className="mx-auto mb-0 rounded-full shadow-lg" src="/VA.png" alt="V-Align" />
