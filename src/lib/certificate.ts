...
export function generateCertificate(data: CertificateData) {
  ...
  // ── Decorative border ──
  doc.setDrawColor(122, 181, 32); // primary-600
  doc.setLineWidth(2);
  ...
  // ── Title ──
  doc.setTextColor(122, 181, 32);
  doc.setFontSize(14);
  doc.setFont("helvetica", "normal");
  doc.text("VA LMS", w / 2, 44, { align: "center" });
